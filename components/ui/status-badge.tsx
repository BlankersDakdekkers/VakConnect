...
const variantClasses: Record<string, string> = {
  ...
  offered: "border-indigo-200 bg-indigo-50 text-indigo-700",
  declined: "border-danger/20 bg-red-50 text-danger",
  expired: "border-border bg-slate-100 text-slate-700",
  skipped: "border-border bg-slate-100 text-slate-700",
  exhausted: "border-accent/20 bg-amber-50 text-amber-700",
  cancelled: "border-border bg-slate-100 text-slate-700",
